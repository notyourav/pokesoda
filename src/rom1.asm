...
; ---------------------- ; 7fff
	...
	DB 90h, 0C1h, 0C1h, 99h, 82h, 80h

	DW @COFF(loc_0x01199D)
...
loc_0x00852E:
	...
	DW @COFF(loc_0x01296A)

	DB 14h, 00h, 0B0h, 0B3h, 0Ah, 00h ; 878b
	ASCII "d" ; 8792
	...
	DB 0B4h, 0C1h, 99h, 0CEh, 87h
	
	DW @COFF(loc_0x01277B)
	...
	DW @COFF(loc_0x0119C1)

	DB 0Ch, 80h, 28h, 00h, 0B8h ; 8c67
...
; ---------------------- ; 0a085
loc_0x00A087:
	LD A,[stage_inside] ; 0a087
	CP A,#01h ; 0a08b
	JRS Z,loc_0x00A0A7 ; 0a08d
	LD A,[pet_breed] ; 0a08f
	CP A,#02h ; 0a093
...
loc_0x00A846:
	...
	LD BA,#000Ah ; 0a84e
	farcall loc_0x018FFE ; 0a854

	OR A,A ; 0a857
	JRS NZ,loc_0x00A860 ; 0a858

	farcall loc_0x01299E ; 0a85d
...
loc_0x00A860:
	...
	LD IY,#@DOFF(pool_00A8F8)
	LD YP,#@DPAG(pool_00A8F8)
...
; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
; Calc pet walking speed
;   Returns:
;     A: delta
	PET_WALK_SPEED equ 2
; - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
global loc_0x00ABDA
loc_0x00ABDA:
	...
	; halve speed for 3 out of 4 frames
	AND A, #11b
	JRS Z, loc_0x00ABE5
...
loc_0x00B140:
	...
	LD [HL],#00h ; 0b151
	farcall loc_0x012F7C ; 0b156
	CARL loc_0x009A9C ; 0b159
	JRS NZ,loc_0x00B16A ; 0b15c
	farcall loc_0x01298A ; 0b161
	farcall loc_0x013005 ; 0b167
loc_0x00B16A:
	RET
; ---------------------- ; 0b16a
loc_0x00B16B:
...
loc_0x00BFD9:
	...
	LD A,#02h ; 0bfe8
	LD [mn_pending_sfx],A ; 0bfea

loc_0x00BFEE:

	XOR A,A ; 0bfee
	LD [pet_visitation],A ; 0bfef

	LD A,#00h ; 0bff3
	LD [pet_close],A ; 0bff5

	LD NB,#@CPAG(loc_0x01898C)
	CARL loc_0x01898C ; 0bffc

	LD A,#00h ; 0bfff
	LD [pet_close_act],A ; 0c001
